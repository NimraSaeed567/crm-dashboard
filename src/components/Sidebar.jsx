...
import { LayoutDashboard, Users, CheckSquare, Sparkles, FileText, Sun, Moon, LogOut, X } from 'lucide-react'
  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-800 text-xs text-gray-400 dark:text-gray-500 truncate">
          {user?.email || 'v0.7 · live data'}
        </div>
      </aside>
    </>
  )
